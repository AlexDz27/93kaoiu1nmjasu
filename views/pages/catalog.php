...
<template id="tmpl-abraziv">
  ...
  <div class="t-list t-list--no-stretch">
    <div class="t-list__ts">
      <?php for ($i = 16; $i <= 31; $i++): $product = $products['Абразивные алмазные материалы и оснастка']["$i"]; ?>
        <div class="t <?= $product['isHit'] ? 't--hit' : '' ?>">
          <p class="t__iz"><?= $i + 1 ?> из <?= $count ?></p>
          <div class="t__body">
            <div class="t__img-cont">
...
<template id="tmpl-valiki">
  ...
  <div class="t-list t-list--no-stretch">
    <div class="t-list__ts">
      <?php for ($i = 16; $i <= 31; $i++): $product = $products['Валики малярные']["$i"]; ?>
        <div class="t <?= $product['isHit'] ? 't--hit' : '' ?>">
          <p class="t__iz"><?= $i + 1 ?> из <?= $count ?></p>
          <div class="t__body">
            <div class="t__img-cont">
  ...
  <div class="t-list t-list--no-stretch">
    <div class="t-list__ts">
      <?php for ($i = 32; $i < $count; $i++): $product = $products['Валики малярные']["$i"]; ?>
        <div class="t <?= $product['isHit'] ? 't--hit' : '' ?>">
          <p class="t__iz"><?= $i + 1 ?> из <?= $count ?></p>
          <div class="t__body">
            <div class="t__img-cont">
